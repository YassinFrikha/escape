...
<html lang="en">
  <head>
    ...
    <title>Camping Tent - ESCAPE</title>
    <link
  ...
  <body>
    ...
    <!-- Product Info -->
    <div class="container">
      <img src="pics/tent (1).jpg" alt="Camping Tent" class="product-image" />
      <p class="description">
        This durable and weather-resistant camping tent is perfect for all your
        outdoor adventures. It fits 2–4 people comfortably, is easy to set up,
        and includes ventilation and rain protection.
      </p>

      <div class="form-group">
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" name="quantity" min="1" value="1" />
        <div class="total-price">Total: <span id="price">150</span> TND</div>
      </div>
