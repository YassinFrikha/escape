...
<html lang="en">
  <head>
    ...
    <title>ESCAPE - Sahara Desert Trips</title>
    <link
  ...
  <body>
    ...
    <div class="trip-list">
      ...
      <?php if ($error): ?>
        <!-- If error, optionally skip showing trips? Or you can remove this block to always show trips -->
      <?php else: ?>
