...
<html lang="en">
  <head>
    ...
    <title>Camping Backpack - ESCAPE</title>
    <link
  ...
  <body>
    ...
    <div class="container">
      <img
        src="pics/backpack.jpg"
        alt="Camping Backpack"
        class="product-image"
      />
      <p class="description">
        This rugged and lightweight camping backpack is perfect for long treks
        and hikes. With multiple compartments and weather resistance, it keeps
        all your gear organized and dry.
      </p>

      <div class="form-group">
        <label for="quantity">Quantity:</label>
        <input type="number" id="quantity" name="quantity" min="1" value="1" />
        <div class="total-price">Total: <span id="price">80</span> TND</div>
      </div>
